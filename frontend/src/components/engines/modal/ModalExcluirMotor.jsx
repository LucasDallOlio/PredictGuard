    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-gray-100 dark:border-zinc-700">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-400 text-center mt-2">
          ...
          <span className="font-semibold text-gray-700 dark:text-zinc-200">{motor.nome}</span>
          {" "}(Código: {motor.cod_registro})?{" "}
          <span className="text-red-500 font-medium">Essa ação não poderá ser desfeita.</span>
        </p>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 py-2.5 rounded-lg bg-red-500 hover:bg-red-600 text-white text-sm font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
